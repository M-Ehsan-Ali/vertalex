...
export const pagesData: PageItem[] = [
  ...
  },
  {
    ...
    uri: "/",
    content: "",
    seo: { title: "Vertalex | Home", metaDesc: "Cost effective & CO2 compliant aluminium solutions." },
  },
];
...
export const postsData: PostItem[] = [
  {
    ...
    title: "Sample Post",
    content: "<p>This is a sample post. Add more in <code>src/data/index.ts</code>.</p>",
...
export const projectsData: ProjectNode[] = [
  {
    projects: {
      ...
      description: "A three tower mixed-use development in the heart of Canary Wharf  comprising buildings of 65, 35 & 20 storeys. Crofton MEA supplied approx. 500 MT across 50 dies with thermal breaks, powder coating, anodizing and mill finish for the facades of these buildings. ",
      color: "445ae0",
  ...
  },
  {
    projects: {
      ...
      description: "A 49 storey landmark residential tower in Birmingham city, UK. ​ We are currently supplying 32 dies, with thermal breaks, powder coating, anodizing and mill finish for the facade of this building. ",
      color: "ffffff",
...
export const testimonialsData: TestimonialNode[] = [
  {
    testimonial: {
      ...
      review: "Stephen's expertise helped me secure funding and mentorship for my startup. By connecting me with angel investors and tech professionals across the globe, he opened doors I didn’t even know existed",
  ...
  },
  {
    testimonial: {
      ...
      review: "As a lecturer in higher education, I was struggling to establish international collaborations. Stephen's approach enabled me to connect with educators and researchers worldwide, leading to joint projects and academic exchanges",
      logo: { sourceUrl: "/userImage.png" },
    },
  },
  {
    testimonial: {
      ...
      review: "Stephen’s LinkedIn strategies have transformed the way I approach networking. By targeting the right keywords and optimizing my profile, I’ve connected with top specialists in the United States and beyond, gaining collaborative opportunities that have significantly boosted my careers",
      logo: { sourceUrl: "/userImage.png" },
    },
  },
];
...
export const newsData: NewsNode[] = [
  {
    New: {
      ...
      description: "An overview of the aluminium market and sustainability trends.",
  ...
  },
  {
    New: {
      ...
      description: "Aluminum is revolutionizing the way we build and create. In this blog post, we'll explore the remarkable potential of aluminum technology, its environmental advantages, and how you can harness this sustainable material for a stronger, more efficient future.",
      readtime: "9 min read",
...
export function getContentNodeBySlug(slug: string, idType: "URI" | "DATABASE_ID") {
  ...
  return contentNodesByUri.get(path) ?? contentNodesByUri.get(withTrailing) ?? contentNodesByUri.get(path.replace(/\/$/, "")) ?? null;
}
